...
let PatientMedicineOrderRepoService = class PatientMedicineOrderRepoService extends db_repo_service_1.DbRepoService {
    medicineOrderModel;
    constructor(medicineOrderModel) {
        super(medicineOrderModel);
        this.medicineOrderModel = medicineOrderModel;
    }
};
PatientMedicineOrderRepoService = __decorate([
    __param(0, (0, mongoose_1.InjectModel)(patient_medicine_record_schema_1.PatientMedicineOrder.name, types_1.connectionNameString.HOSPITAL)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], PatientMedicineOrderRepoService);
exports.default = PatientMedicineOrderRepoService;
//# sourceMappingURL=patient.med.repoService.js.map