...
export declare abstract class DbRepoService<T> {
    ...
    findOne(query: FilterQuery<T>, populate?: string, options?: ProjectionType<T>): Promise<T | null>;
    findAll(query: FilterQuery<T>, options?: ProjectionType<T>, skip?: number, limit?: number, populate?: string): Promise<T[] | never[]>;
    count(query: FilterQuery<T>): Promise<number>;
    findById(id: Types.ObjectId, populate?: string, options?: ProjectionType<T>): Promise<T | null>;
