...
exports.ServiceModule = mongoose_1.MongooseModule.forFeature([{ name: PatientServiceOrder.name, schema: exports.PatientServiceOrderSchema }], types_1.connectionNameString.HOSPITAL);
