...
let Billing = class Billing extends common_1.CommonProps {
    serviceRecords;
    payable;
    taxRate;
    tax;
...
], Billing.prototype, "serviceRecords", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        required: true,
    }),
...
__decorate([
    (0, mongoose_1.Prop)({
        enum: common_1._Types.BillingStatusType,
        default: common_1._Types.BillingStatusType.PENDING,
    }),
...
exports.BillingModule = mongoose_1.MongooseModule.forFeature([
    { name: Billing.name, schema: exports.BillingSchema },
]);
