export declare enum PhysicianRoles {
...
export declare enum NursingRoles {
    REGISTERED_NURSE = "Registered Nurse",
    NURSE_PRACTITIONER = "Nurse Practitioner",
    CRITICAL_CARE_NURSE = "Critical Care Nurse"
}
export declare enum AlliedHealthRoles {
...
export declare enum PharmacyRoles {
    PHARMACY_MANAGER = "Pharmacy Manager",
    PHARMACIST = "Pharmacist",
    PHARMACY_TECHNICIAN = "Pharmacy Technician"
}
export declare enum DiagnosticRoles {
